...
namespace UnitOfWork.Library.PagedList
{
    /// <summary>
    ...
    public class PagedList<T> : ValidationResult, IPagedList<T>
    {
        /// <summary>
    ...
    internal class PagedList<TSource, TResult> : ValidationResult, IPagedList<TResult>
    {
        /// <summary>
